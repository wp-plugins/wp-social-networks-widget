...
Plugin URI: http://www.divinedeveloper.com/plugins/wp-social-network-widget/
...
function social_networks_widget_register() {
	register_widget('WPSocialNetworksWidget');
}
...
class WPSocialNetworksWidget extends WP_Widget {
	...
	function WPSocialNetworksWidget() {
		...
		$this->WP_Widget('social_networks_widget', __('WP Social Networks', 'social_networks_widget'), $widget_ops, $control_ops);
